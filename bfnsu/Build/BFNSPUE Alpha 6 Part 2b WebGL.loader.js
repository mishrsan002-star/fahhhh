function createUnityInstance(t, n, d) {
  function i(e, r) {
    if (!i.aborted && n.showBanner) return "error" == r && (i.aborted = !0), n.showBanner(e, r);
    switch (r) {
      case "error":
        console.error(e);
        break;
  ...
  function e(e, r, t) {
    var n = e[r];
    void 0 !== n && n || (console.warn('Config option "' + r + '" is missing or empty. Falling back to default value: "' + t + '". Consider updating your WebGL template to include the missing config option.'), e[r] = t)
  }
  d = d || function() {};
  var r, c = {
    canvas: t,
  ...
  for (r in e(n, "companyName", "Unity"), e(n, "productName", "WebGL Player"), e(n, "productVersion", "1.0"), n) c[r] = n[r];
  ...
  var l = "",
    ...
    h = (document.addEventListener("webkitfullscreenchange", function(e) {
      document.webkitCurrentFullScreenElement === t ? t.style.width && (l = t.style.width, u = t.style.height, t.style.width = "100%", t.style.height = "100%") : l && (t.style.width = l, t.style.height = u, u = l = "")
    }), {
      Module: c,
  ...
  function p(e, r) {
    if ("symbolsUrl" != e) {
      ...
      for (e in c.downloadProgress) {
        if (!(t = c.downloadProgress[e]).started) return;
        a++, t.lengthComputable ? (n += t.loaded, o += t.total, s++) : t.finished || i++
      }
  ...
  function m() {
    new Promise(function(a, e) {
      ...
      s.src = c.frameworkUrl, s.onload = function() {
        if ("undefined" == typeof unityFramework || !unityFramework) {
          ...
          for (e in r) {
            var t, n = r[e];
            if (c.frameworkUrl.endsWith("." + n[0])) return t = "Unable to parse " + c.frameworkUrl + "!", "file:" == location.protocol ? void i(t + " Loading pre-compressed (brotli or gzip) content via a file:// URL without a web server is not supported by this browser. Please use a local development web server to host compressed Unity content, or use the Unity Build and Run option.", "error") : (t += ' This can happen if build compression was enabled but web server hosting the content was misconfigured to not serve the file with HTTP Response Header "Content-Encoding: ' + n[1] + '" present. Check browser Console and Devtools Network tab to debug.', "br" == n[0] && "http:" == location.protocol && (n = -1 != ["localhost", "127.0.0.1"].indexOf(location.hostname) ? "" : "Migrate your server to use HTTPS.", t = /Firefox/.test(navigator.userAgent) ? "Unable to parse " + c.frameworkUrl + '!<br>If using custom web server, verify that web server is sending .br files with HTTP Response Header "Content-Encoding: br". Brotli compression may not be supported in Firefox over HTTP connections. ' + n + ' See <a href="https://bugzilla.mozilla.org/show_bug.cgi?id=1670675">https://bugzilla.mozilla.org/show_bug.cgi?id=1670675</a> for more information.' : "Unable to parse " + c.frameworkUrl + '!<br>If using custom web server, verify that web server is sending .br files with HTTP Response Header "Content-Encoding: br". Brotli compression may not be supported over HTTP connections. Migrate your server to use HTTPS.'), void i(t, "error"))
          }
    ...
    var n, e = new Promise(function(r, e) {
      ...
      t.open("GET", c[n]), t.responseType = "arraybuffer", t.addEventListener("progress", function(e) {
        p(n, e)
      }), t.addEventListener("load", function(e) {
        p(n, e), r(new Uint8Array(t.response))
      ...
      c.addRunDependency("dataUrl"), e.then(function(e) {
        ...
        for (t += 4; t < o;) {
          var a = r.getUint32(t, !0),
            s = (t += 4, r.getUint32(t, !0)),
            i = (t += 4, r.getUint32(t, !0)),
            d = (t += 4, String.fromCharCode.apply(null, e.subarray(t, t + i)));
          t += i;
  ...
  return c.SystemInfo = function() {
    var e, r, t, n, o = navigator.userAgent + " ",
      a = [
        ["Firefox", "Firefox"],
        ["OPR", "Opera"],
        ["Edg", "Edge"],
    ...
    "Safari" == e && (r = s("Version/(.*?) ", o, 1)), "Internet Explorer" == e && (r = s("rv:(.*?)\\)? ", o, 1) || r);
    for (var d = [
        ["Windows (.*?)[;)]", "Windows"],
    ...
    function e() {
      ...
      function n(e) {
        if (void 0 === t.database)
          for (t.database = e, t.database || l("indexedDB database could not be opened"); t.queue.length;) {
            var r = t.queue.shift();
      ...
      try {
        ...
        e.onupgradeneeded = function(e) {
          ...
          e.version < s.version ? (e.close(), (r = o.open(s.name, s.version)).onupgradeneeded = function(e) {
            e = e.target.result;
    ...
    e.prototype.execute = function(e, r, t, n, o) {
      if (this.database) try {
        var a = this.database.transaction([e], -1 != ["put", "delete", "clear"].indexOf(r) ? "readwrite" : "readonly").objectStore(e),
          s = ("openKeyCursor" == r && (a = a.index(t[0]), t = t.slice(1)), a[r].apply(a, t));
    ...
    function t(e) {
      this.cache = {
        ...
        var e = this.xhr,
          r = this.cache;
        r.enabled && !r.revalidated && (304 == e.status ? (r.result.revalidated = r.result.accessed, r.revalidated = !0, u.execute(i.name, "put", [r.result]), l("'" + r.result.url + "' successfully revalidated and served from the indexedDB cache")) : 200 == e.status ? (r.result = c(r.result.url, r.company, r.product, r.result.accessed, e), r.revalidated = !0, u.execute(i.name, "put", [r.result], function(e) {
    ...
    t.prototype.send = function(e) {
      ...
      return this.cache.result = c(a(r), this.cache.company, this.cache.product, Date.now()), this.cache.enabled = -1 != ["must-revalidate", "immutable"].indexOf(this.cache.control) && "GET" == e && this.cache.result.url.match("^https?://") && (void 0 === t || t) && void 0 === n && void 0 === o, this.cache.revalidated = !1, this.xhr.open.apply(this.xhr, arguments)
    ...
    for (r in n) t.prototype.hasOwnProperty(r) || ! function(r) {
    ...
    c.SystemInfo.hasWebGL ? c.SystemInfo.hasWasm ? (1 == c.SystemInfo.hasWebGL && c.print('Warning: Your browser does not support "WebGL 2.0" Graphics API, switching to "WebGL 1.0"'), c.startupErrorHandler = r, d(0), c.postRun.push(function() {
